...
export async function POST(request: Request) {
  try {
    ...
    const newProperty = {
      ...
      ...body,
      sharesOutstanding: Math.floor(body.maxShareSupply * 0.75),
      accumulatedDividends: Math.floor((body.valuationUsd * body.annualYieldPercentage) / 100 * 1e18),
      currentSharePrice: body.valuationUsd ? body.valuationUsd / body.maxShareSupply : 0,
      sharesAvailable: Math.floor(body.maxShareSupply * 0.25),
      isBookable: true,
      hourlyRate: 200,
      dailyRate: 1200,
